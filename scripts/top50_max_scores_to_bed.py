#!/usr/bin/env python3
"""
Find top 50 max scores from SpliceAI_MAF_non_exonic.tsv and convert to BED format.
"""
...
def main():
    # File paths
    spliceai_file = "SpliceAI_MAF_non_exonic.tsv"
    decoy_bed_file = "decoyIDs.bed"
    output_bed = "SpliceAI_MAF_non_exonic_top50.bed"
    ...
    print("\nCalculating max scores for each decoy ID...")
    ...
    print(f"\nLoading decoy BED file: {decoy_bed_file}")
    ...
    print(f"\nMatching decoy IDs and creating BED file...")
